...
Use the [current architecture](https://github.com/yxflc11/openbot/blob/53adb487af506ce7089d2252719175427282e0c1/docs/ARCHITECTURE.md), [repository map](https://github.com/yxflc11/openbot/blob/53adb487af506ce7089d2252719175427282e0c1/docs/REPOSITORY_MAP.md) and [engineering audit](https://github.com/yxflc11/openbot/blob/53adb487af506ce7089d2252719175427282e0c1/docs/REPOSITORY_AUDIT.md) to find extension points and verification commands. The optional office visualization remains deferred; it is not part of the collaboration runtime.
