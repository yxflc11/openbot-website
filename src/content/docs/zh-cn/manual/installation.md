...
> 下载 [macOS / Windows alpha.8 预览版](https://github.com/yxflc11/openbot/releases/tag/desktop-v0.1.0-alpha.8)，并核对随附的 SHA256SUMS。安装器尚未签名，macOS 包尚未公证，保留系统信任提示。
...
本版本的 [desktop-manifest.json](https://github.com/yxflc11/openbot/releases/download/desktop-v0.1.0-alpha.8/desktop-manifest.json) 记录安装器源码提交与各平台文件。请将下载文件名和 SHA-256 与同一发行版的 [SHA256SUMS](https://github.com/yxflc11/openbot/releases/download/desktop-v0.1.0-alpha.8/SHA256SUMS) 核对。更新需手动安装，目前没有自动更新器。

## macOS 安装

1. 下载 alpha.8 的 [Apple Silicon DMG](https://github.com/yxflc11/openbot/releases/download/desktop-v0.1.0-alpha.8/openbot-desktop-0.1.0-alpha.8-darwin-arm64.dmg)，核对发布页的 SHA256SUMS。
...
1. 下载 alpha.8 的 [Windows x64 安装器](https://github.com/yxflc11/openbot/releases/download/desktop-v0.1.0-alpha.8/openbot-desktop-0.1.0-alpha.8-win32-x64.exe)，核对文件名和发布页 `SHA256SUMS` 中的校验值。
...
也可连接独立部署的 Server。插件中的 localhost 始终指服务电脑，不一定是当前客户端。平台证据与打包细节见 [当前 Windows 工程说明](https://github.com/yxflc11/openbot/blob/main/docs/WINDOWS_DESKTOP.zh-CN.md)。该说明跟随 `main` 更新，内容可能晚于 alpha.8；安装器的实际源码以本版本发布页与上述 manifest 为准。
