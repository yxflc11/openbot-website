...
参考 [示例源码](https://github.com/yxflc11/openbot/blob/53adb487af506ce7089d2252719175427282e0c1/apps/server/src/plugin-example.ts) 和 [MCP 文档](https://modelcontextprotocol.io/docs/getting-started/intro)。示例是开发服务，不是公开托管的在线端点。
