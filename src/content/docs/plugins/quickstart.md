...
See [example source](https://github.com/yxflc11/openbot/blob/53adb487af506ce7089d2252719175427282e0c1/apps/server/src/plugin-example.ts) and [MCP documentation](https://modelcontextprotocol.io/docs/getting-started/intro). The example is a development service, not a public hosted endpoint.
